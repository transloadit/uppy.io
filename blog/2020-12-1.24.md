...
![A code window on a pink background, wearing a Santa hat, showing a Svelte component that imports Dashboard from @uppy/svelte and Webcam from @uppy/webcam and renders the Dashboard](/img/blog/1.24/uppy-svelte.png)
