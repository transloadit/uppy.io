...
<img alt="The refreshed Dashboard design" className="border" src="/img/blog/0.24/dashboard-main.jpg" />

<img alt="The refreshed Dashboard with files selected" className="border" src="/img/blog/0.24/uppy-screenshot.jpg" />

Meta editing screen:

<img alt="The Dashboard's meta editing screen" className="border" src="/img/blog/0.24/dashboard-meta-edit.jpg" />

Camera screen:

<img alt="The Dashboard's camera screen" className="border" src="/img/blog/0.24/import-from-camera.jpg" />

Import from URL (Link):

<img alt="The Dashboard's import-from-URL screen" className="border" src="/img/blog/0.24/import-from-url.jpg" />
...
<img alt="The simplified StatusBar, showing only a percentage" src="/img/blog/0.24/statusbar-2.jpg" />
...
<img alt="The StatusBar with showProgressDetails on, spreading the detail over two lines" src="/img/blog/0.24/statusbar-1.jpg" />
...
<img alt="The &quot;Powered by Uppy&quot; credit shown at the bottom of the Dashboard" src="/img/blog/0.24/powered-by-1.jpg" />
