...
![The Uppy DragDrop area in its focused state: a dashed border ringed by a blue focus outline, around a grey arrow and the text "Drop files here or browse"](/img/blog/1.3/drag-drop-focus.png)
...
- Custom plugin
  [example](http://uppy.io/docs/guides/building-plugins/#example-of-a-custom-plugin)
