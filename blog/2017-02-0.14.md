...
<img alt="Remote provider authentication opening in its own tab and closing again once complete" className="border" src="/img/blog/0.14/smooth-auth.png" />
...
<img alt="The Dropbox plugin browsing files from inside Uppy" className="border" src="/img/blog/0.14/uppy-dropbox.png" />
...
<figure class="wide">
  <img alt="The Dashboard file grid beside the compact list view it falls back to when space is tight" src="/img/blog/0.14/dashboard-grid-list.jpg" />
</figure>
...
<img alt="The StatusBar showing uploaded and total size alongside progress" src="/img/blog/0.14/statusbar-uploaded-total-size.png" />
...
<img alt="The DragDrop plugin with its interface in Finnish" src="/img/blog/0.14/dnd-fi.png" />
