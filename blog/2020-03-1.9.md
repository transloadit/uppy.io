...
![The Uppy Dashboard with three selected files — a JPG, a WMV and an MP3 — each shown on a coloured tile with an icon for its type: purple with a picture icon, green with a video camera, blue with a music note](/img/blog/1.9/file-type-icons.png)
