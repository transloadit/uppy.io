...
<img alt="The Dashboard showing the note &quot;Images and video only, 300kb or less&quot;" className="border" src="/img/blog/0.17/restrictions-note.jpg" />
...
<figure class="wide">
  <img alt="The Instagram plugin browsing photos from inside Uppy" className="border" src="/img/blog/0.17/instagram-ui.jpg" />
</figure>
...
<img alt="The redesigned provider file browser, with search" className="border" src="/img/blog/0.17/provider-search.jpg" />
