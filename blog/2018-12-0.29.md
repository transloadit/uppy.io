...
<img alt="Uppy core and its plugins, each with its stylesheet separated out" src="/img/blog/0.29/uppy-core-plugins-separate-styles.jpg" />
...
<img alt="How overall progress is calculated when some files have no known size" src="/img/blog/0.29/progress-size-calculation.jpg" />
