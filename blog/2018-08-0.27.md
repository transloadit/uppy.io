...
<img alt="The 0.27 Dashboard's initial screen" src="/img/blog/0.27/uppy-add-initial.jpg" />
...
<img alt="The old Dashboard, with a tab bar across the top for each import source" src="/img/blog/0.27/uppy-with-tabs.jpg" />

So in `0.27`, we are iterating on the UI again:

<img alt="The new initial screen, with the providers shown as a row of coloured icons" src="/img/blog/0.27/uppy-add-initial.jpg" />
...
<img alt="The Dashboard with files selected, the provider icons now behind a plus button" src="/img/blog/0.27/uppy-files-selected.jpg" />

You can always add more:

<img alt="The add-more screen reached from the plus button" src="/img/blog/0.27/uppy-add-more.jpg" />

The StatusBar that shows progress has been “lightened”:

<img alt="The lightened StatusBar during an upload" src="/img/blog/0.27/uppy-upload-in-progress.jpg" />

<img alt="The StatusBar once the upload is complete" src="/img/blog/0.27/uppy-upload-complete.jpg" />
...
<img alt="The refined mobile version of the Dashboard" src="/img/blog/0.27/uppy-mobile.jpg" />
...
<img alt="A table of mingzipped bundle sizes for each Uppy package" width="400" src="/img/blog/0.27/uppy-sizes.png" />
