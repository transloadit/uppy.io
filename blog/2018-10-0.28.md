...
<img alt="The Dashboard uploading files" className="border" src="/img/blog/0.28/dashboard-uploading.jpg" />
...
<img alt="The Status Bar while uploading, with a spinner" className="border"
style={{borderTop: 0}} src="/img/blog/0.28/status-bar-uploading.png" />

<img alt="The Status Bar while paused" className="border" style={{borderTop: 0}}
src="/img/blog/0.28/status-bar-paused.png" />

<img alt="The Status Bar while encoding, in its own colour" className="border"
style={{borderTop: 0}} src="/img/blog/0.28/status-bar-encoding.png" />

<img alt="The Status Bar once the upload is complete" className="border"
style={{borderTop: 0}} src="/img/blog/0.28/status-bar-complete.png" />
