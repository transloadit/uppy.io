...
![The Google Drive web interface with a file named "I-am-shortcut_Screenshot 2020-07-28 at 21.47.47.png" selected, its icon marked with a shortcut arrow](/img/blog/1.30/drive-shortcut.png)

![The same shortcut file listed and ticked in Uppy's "Import from Google Drive" browser, alongside folders and other files, with a "Select 1" button at the bottom](/img/blog/1.30/uppy-shortcut.png)
