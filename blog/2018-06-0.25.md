...
<img alt="A provider's file browser with a Select button, so files are added only once the selection is confirmed" src="/img/blog/0.25/new-select-provider.jpg" />
