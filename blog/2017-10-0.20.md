...
<img alt="The DragDrop plugin filling its container, with a note about restrictions underneath" className="border" src="/img/blog/0.20/dnd-gray.jpg" />
...
- Documentation for the [StatusBar](/docs/status-bar),
  [XHRUpload](/docs/xhr-upload) and [Tus](/docs/tus) plugins.
