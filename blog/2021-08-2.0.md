...
[try Uppy live demo](https://uppy.io/examples).
...
- Support for 25 more languages (bringing it to a total of
  [37](/docs/locales/#list-of-locales))
...
![Screen recording of the Uppy Dashboard before the optimizations, with the browser's performance spinner showing sustained work while files are added](/img/blog/2.0/uppy-performance-before.gif)

And after:

![The same screen recording after the optimizations, where adding the files finishes noticeably faster](/img/blog/2.0/uppy-performance-after.gif)
...
[“writing plugins”](/docs/guides/building-plugins) guide.
...
The [`@uppy/aws-s3-multipart`](/docs/aws-s3/) plugin can be used to upload files
