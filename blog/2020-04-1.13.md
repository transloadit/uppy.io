...
try it out on [the Dashboard example page](/examples).
...
![The Uppy Dashboard in dark mode: a black panel reading "Drop files here, paste, browse or import from:" above buttons for My Device, Google Drive, Dropbox, Instagram, Link, Facebook and Camera](/img/blog/1.13/uppy-dashboard-dark-mar-2020.png)
