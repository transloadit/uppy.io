...
![The Uppy Dashboard in single file mode, showing one selected photo of a spaniel sitting in front of a decorated Christmas tree, above an “Upload 1 file” button](/img/blog/3.1-3.3/dashboard-christmas.jpg)
...
<img alt="The Dashboard in single file mode, showing the one selected image large and centred" src="/img/blog/3.1-3.3/single-file-mode.jpg" className="border" />
...
![A golden retriever in a Santa hat leaning out of a car window, captioned “Jingle all the way”](/img/blog/3.1-3.3/driving-home.gif)
