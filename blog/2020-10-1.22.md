...
![The Uppy Webcam plugin showing a live camera preview, with a camera-selection dropdown reading "FaceTime HD Camera (Built..." beside the photo and record buttons](/img/blog/1.22/webcam-dropdown-full.png)

![The same camera dropdown opened, listing "OBS Virtual Camera" (checked) and "FaceTime HD Camera (Built-in)"](/img/blog/1.22/webcam-dropdown-short.png)
...
![The Uppy Unsplash plugin showing a grid of pumpkin photographs returned by a search, under an "Import from Unsplash" title bar](/img/blog/1.22/unsplash.jpg)
