...
existing Uppy UI plugins, such as the [Dashboard](/examples) and
[DragDrop](/examples) plugins. They aren't ready yet, but if you'd like to
follow along with development, check out the work that has been done so far in
pull request [#170](https://github.com/transloadit/uppy/pull/170)!
...
<img alt="Files in the Dashboard badged with the logo of the service each came from" src="/img/blog/0.16/service-logos.png" />
