...
You must define this option, otherwise you’ll be using the
[legacy version of this plugin](./aws-s3). If you use the deprecated
`@uppy/aws-s3-multipart` package, this will be set to `true` by default, which
is not a recomended setting.
