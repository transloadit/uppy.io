...
this automatically, however you must configure your S3 bucket to have publically readable objects. For the XHRUpload plugin, you may have to specify a custom
