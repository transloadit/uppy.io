...
servers, all you have to do is simply create a [Template][transloadit-concepts]
that describes what should happen to the uploaded files. Transloadit accepts the
