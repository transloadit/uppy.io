...
Checkout the [storage quotas](https://developer.mozilla.org/en-US/docs/Web/API/Storage_API/Storage_quotas_and_eviction_criteria#other_web_technologies) on MDN to see how much data can be stored depending on the device and browser.
