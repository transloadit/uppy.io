...
By default, Golden Retriever stores metadata, state, and local files up to 10 MiB
in IndexedDB. If IndexedDB is unavailable, metadata and state fall back to
