...
<details>
  <summary>How much data can Golden Retriever store?</summary>

The amount of storage is dependent upon how much available disk space the device
has. The general range is between 50MB and 20GB.

| Disk Space | Storage Limit                     |
| ---------- | --------------------------------- |
| < 8GB      | 50MB                              |
| > 8-32GB   | 500MB                             |
| > 32-128GB | 4% of volume size                 |
