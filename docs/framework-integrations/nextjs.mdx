...
For new integrations, use the maintained App Router example and shared security
model in the canonical
[Next.js + Uppy + Transloadit guide](/docs/guides/uppy-transloadit#nextjs). The
manual-HMAC example below is retained only for existing integrations.
