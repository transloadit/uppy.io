...
:::caution A couple things to keep in mind when using Uppy with React:
...
your Transloadit template.

Here is what that could look like.

:::note This is the only exception for having Uppy inside the component. :::
