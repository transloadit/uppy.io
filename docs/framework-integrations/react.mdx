...
- `<ProgressBar />` renders [`@uppy/progress-bar`](/docs/progress-bar) - Deprecated in Uppy 5.0
...
Play around with the React headless components in [StackBlitz](#todo)
...
Play around with the React headless hooks in [StackBlitz](#todo)
