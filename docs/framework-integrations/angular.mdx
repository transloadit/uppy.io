...
- `<uppy-dashboard />` renders [`@uppy/dashboard`](/docs/user-interfaces/dashboard)
- `<uppy-drag-drop />` renders [`@uppy/drag-drop`](/docs/user-interfaces/drag-drop)
- `<uppy-progress-bar />` renders [`@uppy/progress-bar`](/docs/user-interfaces/progress-bar)
- `<uppy-status-bar />` renders [`@uppy/status-bar`](/docs/user-interfaces/status-bar)
...
All components have their own styling and should be added to your component decorator.
You can find the CSS import statements in the docs of the UI plugin you want to use.
For instance, for `@uppy/dashboard`:
