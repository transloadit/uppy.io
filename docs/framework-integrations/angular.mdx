...
- `<uppy-dashboard />` renders [`@up/docs/dashboard`](/docs/dashboard)
...
you want to use. For instance, for `@up/docs/dashboard`:
...
@Component({
  ...
  styleUrls: [
    ...
    '../node_modules/@up/docs/dashboard/dist/style.css',
  ],
})
```
