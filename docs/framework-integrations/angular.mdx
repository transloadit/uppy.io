...
- `<uppy-dashboard />` renders
  [`@uppy/dashboard`](/docs/user-interfaces/dashboard)
- `<uppy-drag-drop />` renders
  [`@uppy/drag-drop`](/docs/user-interfaces/drag-drop)
- `<uppy-progress-bar />` renders
  [`@uppy/progress-bar`](/docs/user-interfaces/progress-bar)
- `<uppy-status-bar />` renders
  [`@uppy/status-bar`](/docs/user-interfaces/status-bar)
