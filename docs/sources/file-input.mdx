...
As of Uppy 5.0, `@uppy/file-input` is deprecated. Prefer the headless hooks
(e.g., `useFileInput`) from `@uppy/react`, `@uppy/vue`, or `@uppy/svelte`, or
use [`@uppy/dashboard`](/docs/dashboard/). See the migration notes in the
