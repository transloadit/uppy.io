...
- If you want to support [Team folders / Teams spaces](https://developers.dropbox.com/dbx-team-files-guide), counterintuitively do **not** enable any Team scopes under Permissions.
