...
When you want to let users import files from any WebDAV supported service,
such as Nextcloud, OwnCloud, and Box.

This plugin only supports public WebDAV URLs. Some providers offer WebDAV with OAuth,
which is not supported.

A [Companion](/docs/companion) instance is required for the WebDAV plugin to work.
