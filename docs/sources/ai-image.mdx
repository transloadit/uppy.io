...
using
[Transloadit’s 🤖 `/image/generate` Robot](https://transloadit.com/docs/robots/image-generate/).
...
The plugin focuses on wiring Uppy into Transloadit’s AI image generation. It
does **not** manage your Transloadit Templates for you — instead, you send
`steps` at runtime from your server, similar to the “overruling templates at
...
3. Uses those values to start a Transloadit Assembly that runs the 🤖
...
[Transloadit’s authentication docs](https://transloadit.com/docs/api/authentication/).
