...
<TabItem value="yarn" label="Yarn">
	```shell yarn add @uppy/xhr-upload ```
</TabItem>
...
:::note
This response data will be available on the file’s `.response` property and will be emitted in the [`upload-success`][uppy.upload-success] event:
:::
