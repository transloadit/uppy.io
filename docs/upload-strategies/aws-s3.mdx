...
Wondering if you need this plugin or [`@uppy/aws-s3-multipart`](docs/upload-strategies/aws-s3-multipart)? See “[Which one should I pick](/docs/guides/choosing-upload-strategy#which-one-should-i-pick)”.
:::
...
A function that returns upload parameters for a file (`Promise<Object>`, default: `null`).
...
### What makes a provider S3 compatible?
