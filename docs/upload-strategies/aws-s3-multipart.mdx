...
The `@uppy/aws-s3-multipart` plugin can be used to upload files directly to an S3 bucket (or S3-compatible provider) using S3’s Multipart upload strategy.
