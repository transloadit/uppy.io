...
As of Uppy 5.0, `@uppy/progress-bar` is deprecated. Use Dashboard or build a custom indicator with Uppy’s `progress`/`upload-progress` events (see examples in the [migration guide](/docs/guides/migration-guides/)).
