...
As of Uppy 5.0, `@uppy/informer` was merged into [`@uppy/dashboard`](/docs/dashboard/). Use Dashboard’s built-in notifications triggered via [`uppy.info()`](/docs/uppy#infomessage-type-duration). See the migration notes in the [migration guide](/docs/guides/migration-guides/).
