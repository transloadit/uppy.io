...
```shell
npm install @uppy/core @up/docs/dashboard
```
...
```shell
yarn add @uppy/core @up/docs/dashboard
```
...
The `@up/docs/dashboard` plugin includes CSS for the Dashboard itself, and the
